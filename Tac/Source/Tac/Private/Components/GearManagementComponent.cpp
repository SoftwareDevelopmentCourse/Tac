...
{
	AGears* GearObj = Cast<AGears>(GearToSpawn->GetDefaultObject());
	JudgeByType(GearObj);
}
...
================================================================*/
void UGearManagementComponent::JudgeBySocket(AGears* GearToJudge)
{
...
void UGearManagementComponent::JudgeByType(AGears * GearToJudge)
{
